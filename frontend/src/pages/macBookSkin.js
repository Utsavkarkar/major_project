...
import { MackbookSkins } from './Constant/data'
import { toast } from 'react-toastify'

const MacBookSkinsLaptop = () => {
  ...
  return (
    <div>
      <div>
        {/* Mackbook skins cards */}
        <section>
          <div className="container">
            <h2 className="title">MackBook-skins</h2>
            <div className="row">
              {MackbookSkins.map((i) => {
                return (
...
export default MacBookSkinsLaptop
